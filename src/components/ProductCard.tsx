        ...
        <div className="relative rounded-2xl overflow-hidden border border-[var(--glass-border)] bg-[var(--glass-bg)] backdrop-blur-xl transition-all duration-500 group-hover:shadow-[0_0_30px_rgba(0,240,255,0.15),0_0_60px_rgba(0,240,255,0.05)] group-hover:-translate-y-2 group-hover:scale-[1.02]">
          ...
          <button
            ...
            className={`absolute top-3 right-3 z-20 p-2 rounded-full backdrop-blur-md border transition-all duration-300 ${
              wishlisted
                ? "bg-primary/20 border-primary/50 text-primary shadow-[0_0_12px_rgba(0,240,255,0.3)]"
                : "bg-background/30 border-[var(--glass-border)] text-foreground/60 hover:text-primary hover:border-primary/50"
            }`}
          >
