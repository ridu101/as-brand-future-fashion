    ...
    >
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/wishlist" className="p-2 rounded-xl hover:bg-primary/10 transition-colors">
        ...
        {mobileOpen && (
          ...
          >
            <div className="flex flex-col gap-2 py-2">
              {navLinks.map(link => (
                <Link key={link.path} to={link.path} className="px-4 py-2 rounded-xl text-sm hover:bg-primary/10 transition-colors text-foreground/70">
                  {link.label}
                </Link>
              ))}
              <Link to="/customer-login" className="neon-button-outline px-4 py-2 text-sm text-center mt-2">
                Login
              </Link>
            </div>
          </motion.div>
